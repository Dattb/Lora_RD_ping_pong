...
//          {
//        	  APP_LOG(TS_ON, VLEVEL_L, "RD receive:  PONG\n\r");
...
//          {
//        	  APP_LOG(TS_ON, VLEVEL_L, "RD receive:  PING\n\r");
...
//          Buffer[i] = i - 4;
//        }
//        //if(ping_flag)//RD_EDIT: chu dong ping pong
//        //APP_LOG(TS_ON, VLEVEL_L, "Master Tx start\n\r");
////        APP_LOG(TS_ON, VLEVEL_L, "Ping flag = %d\n\r",ping_flag);
...
//        time Busy_signal is ON in RX opening window */
//        HAL_Delay(Radio.GetWakeupTime() + TCXO_WORKAROUND_TIME_MARGIN);
//        //if(ping_flag) //RD_EDIT: chu dong pinh pong
//        Radio.Send(Buffer, BufferSize);
//      }
//      else
//      {
